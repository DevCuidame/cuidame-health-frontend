    ...
    <ion-content class="ion-padding">
      <div class="appointment-detail" *ngIf="appointment">
        ...
        <div class="detail-section">
          <h3>Profesional</h3>
          <p *ngIf="!isUnassignedAppointment()">
            Dr. {{ appointment.professional?.user?.name }}
            {{ appointment.professional?.user?.lastname }}
          </p>
          <p *ngIf="isUnassignedAppointment()">Pendiente de asignación</p>
          <p class="detail-info" *ngIf="!isUnassignedAppointment()">
...
export class PatientAppointmentDetailModalComponent {
  ...
  isUnassignedAppointment(): boolean {
    ...
    // Verificar si la fecha está más de 50 años en el futuro
